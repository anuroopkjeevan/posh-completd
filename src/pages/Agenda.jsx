              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-8">
                <div className="space-y-4">
                  <div className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3"></span>
                    <span className="text-gray-700">Future-proofing maritime education: adapting to emerging technologies</span>
                  </div>
                  <div className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3"></span>
                    <span className="text-gray-700">Upskilling the maritime workforce: bridging academia and industry</span>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3"></span>
                    <span className="text-gray-700">Funding and risk management in ports, shipping, and shipbuilding</span>
                  </div>
                  <div className="flex items-start">
                    <span className="inline-block w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3"></span>
                    <span className="text-gray-700">Strategic alliances in the maritime sector for competitive advantage</span>
                  </div>
                </div>
              </div>
                      <div className="bg-blue-700 py-4 px-6">
